...
<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            ?>
            <div class="row">
                <div style="font-size:20px;width:100%;text-align:center">********************************</div>
                    ...
                    <tbody>
                        ...
                        if( $products ) {
                            foreach ( $products as $_produit) {
                                ...
                                <tr>
                                    <td class="">
                                        ...
                                        <?php echo $_produit[ 'QUANTITE' ];?> &mdash;
                            ...
                            <!-- <tr>
                                ...
                                <td class="text-right">
                                <?php echo $this->Nexo_Misc->cmoney_format( $order[ 'order' ][0][ 'NET_TOTAL' ] );?>
                                <?php 
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                <?php 
                                echo $this->Nexo_Misc->cmoney_format( $order[ 'order' ][0][ 'TOTAL' ] );
                                // echo $this->Nexo_Misc->cmoney_format( 
                                //     bcsub(
                            ...
                            <?php echo $this->events->apply_filters_ref_array( 
                                'render_taxes_light_receipt', 
                                [
                                    $view,
                                    compact( 'total_discount', '_produit', 'order', 'flat_discount', 'total_global', 'total_quantite' )
                                ]
                            );?>
                ...
                <?php include_once( MODULESPATH . '/nexo/views/receipts' . '/barcode.php' );?>
                <!-- <p class="text-center"><?php echo xss_clean( $order[ 'order' ][0][ 'CODE' ] );?></p> -->
